...
Review the theory on [Frame Synchronization](../../_docs/FrameSync.pdf) taken from the ECE 350 text chapter 10. Further description of frame synchronization is in the text *CR Johnson, WA Sethares, Software Receiver Design, Cambridge, 2011* chapter 8, section 8.5.
